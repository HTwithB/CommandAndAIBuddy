...
{
    internal class AnimatorStateSave
    {
        #region Static
        ...
        public static void LoadAllState()
        {
            ...
            foreach (var pair in animatorStateSaves)
            {
                ...
                if (!pair.Key.TryGetComponent<Animator>(out var animator)) continue;
        ...
        public void Save(Animator animator)
        {
            ...
            animatorParameters = new SaveParameter[animator.parameterCount];
