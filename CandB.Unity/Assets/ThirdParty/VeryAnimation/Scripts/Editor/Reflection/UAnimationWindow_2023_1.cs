...
namespace VeryAnimation
{
    ...
    {
        protected UEditorWindow_2023_1 uEditorWindow_2023_1;

        protected class UAnimationWindowState_2023_1 : UAnimationWindowState
        {
        ...
        public UAnimationWindow_2023_1()
        {
            ...
            uAnimationWindowState = uAnimationWindowState_2023_1 = new UAnimationWindowState_2023_1(asmUnityEditor);
        ...
        public override void PropertySortOrFilterByBindings(List<EditorCurveBinding> bindings)
        {
            ...
            if (bindings != null && bindings.Count > 0)
            {
                ...
                uAnimationWindowState_2023_1.SetFilteredCurves(aws, uAnimationWindowSelectionItem.swapDummyCurves);
